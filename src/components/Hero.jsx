    ...
    return(
        <div className="w-full h-screen bg-[#36343B] overflow-hidden" >
            <div className="flex justify-between px-[20px] text-white text-[140%]" >
                ...
                <div className="flex items-center gap-10 text-[140%] hover:cursor-pointer font-[cursive6]" >
            ...
            <div className="flex justify-between px-[20px] translate-y-[50px] translate-x-[-130px]" >
                <div className="w-[60%] h-auto " ><img src={poker} alt="logo" /></div>
            </div>  
            <div className="w-[60vw] h-auto flex flex-col items-start translate-y-[-420px] translate-x-[620px] text-white gap-[15px]" >
